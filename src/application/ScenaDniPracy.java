...
public class ScenaDniPracy implements Initializable 
{
	...
	public void bZapiszZmianyClicked() throws ClassNotFoundException, SQLException 
	{
		...
		if (selectedDzien == -1) 
		{
			JOptionPane.showMessageDialog(null, "Wybierz dzie� pracy");
		} 
		else if (selectedAktywnosc == -1) 
		{
			JOptionPane.showMessageDialog(null, "Wybierz aktywno��");
		}
		else 
		{
			if (selectedPracownik == -1) 
			{
				...
				selectedDzien = -1;
				selectedAktywnosc = -1;
				JOptionPane.showMessageDialog(null, "Zaktualizowano dane aktywno�ci");
			} 
			else
			{
				aktualizujAktywnosci();
				try 
				{
					...
					selectedAktywnosc = -1;
					selectedPracownik = -1;
					JOptionPane.showMessageDialog(null, "Zaktualizowano dane aktywno�ci i pracownika");
				} 
