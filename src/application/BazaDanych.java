...
public class BazaDanych 
{
	...
	public static void wczytajPracownikowWAktywnosci(int idAktywnosci)
	{
		...
		{
			JOptionPane.showMessageDialog(null, "B≥πd przy pobieraniu danych. Sprawdü po≥πczenie internetowe");
	...
	public static void aktualizujAktywnosci(int idAktywnosci, String opis, String godzinaOd, String godzinaDo)
	{
		...
		{
			JOptionPane.showMessageDialog(null, "B≥πd przy aktualizowaniu danych.");
			System.err.println(e);
			e.printStackTrace();
		}
	}
	...
	public static void insert() throws SQLException 
	{
		...
		{
			JOptionPane.showMessageDialog(null, "Nie uda≥o siÍ zapisaÊ danych. Sprawdü po≥πczenie internetowe");
			System.err.println(e);
		}
		/*
	...
	public static int getLastId(String nazwaID, String tabela) throws SQLException
	{
		...
		{
			System.out.println("Nie uda≥o siÍ pobraÊ id. Brak po≥πczenia z bazπ");
			System.err.println(e);
			return -1;
		}
	}
	...
	public static boolean dbConnection() throws SQLException, ClassNotFoundException
	{
		try
		{
			...
			String connectionURL = "jdbc:sqlserver://217.113.235.83:1433;user=zatrans_db_user;password=%NeVer_mind.52;useUnicode=true;characterEncoding=utf8;databaseName=dbTest;"; //Po≥πczenie z bazπ
	...
	public static int isDayInDatabase(int wybranyDzien, int wybranyMiesiac, int wybranyRok) 
	{
		...
		{
			JOptionPane.showMessageDialog(null, "Brak po≥πczenia z bazπ danych.");
			System.err.println(e);
			e.printStackTrace();
			return -1;
		}
